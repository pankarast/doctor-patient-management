...
function Profile() {
    ...
    const {userType, userId, userName, updateUserName} = useAuth();
      ...
      const formData =
        userType === "doctor"
          ...
          : {
            ...
            const endpoint = userType === "doctor" ? `http://localhost:8080/doctors/${userId}` : `http://localhost:8080/patients/${userId}`;
      try {
